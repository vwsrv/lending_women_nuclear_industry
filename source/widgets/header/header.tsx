    ...
    <header className='box-border relative h-[801px]'>
      <div className='pl-20 pr-20'>
        <div className='pt-24 relative z-50'>
          ...
          />
          <p className='max-w-[743px] text-xl leading-6 m-0 mt-10'>{description}</p>
        ...
        <Image
          ...
          height={cloudMoleculeImage.height} alt="" 
        />
        <Image 
      ...
      <div className="h-[128px] bg-[#2D2458] relative z-30 flex justify-between">
        ...
        />
        <p className='self-center text-[45px] font-bold text-white w-[814px] mt-[17px] text-center'>форум и премия</p>
      </div>
    </header>
  )
}